    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">Choicetime</h3>
            <p className="text-sm mb-4">
              Your one-stop destination for watches, wallets, belts, and accessories. Shop the latest trends with the best prices.
            </p>
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/choice_collection_kothrud" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-pink-500 transition">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-start">
                ...
                <span>support@choicetime.in</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li className="flex items-start">
                ...
                <span>Kothrud, Pune,<br />Maharashtra, India 411038</span>
              </li>
            </ul>
          </div>
        </div>
