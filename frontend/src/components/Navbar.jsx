...
const Navbar = () => {
  ...
  return (
    <>
      ...
      ======================= */}
      <header 
        className={`sticky top-0 left-0 right-0 z-50 transition-all duration-300 transform
            ...
            <div className="relative flex items-center justify-between h-10 md:h-12">
              ...
              <div className="flex items-center absolute left-1/2 -translate-x-1/2">
                <Link to="/" className="flex-shrink-0 group relative z-10">
                  <img 
                    src="https://res.cloudinary.com/dsn3dqa6k/image/upload/v1769831512/f722e805-b33b-49c1-84bd-ea11802a3c13.png" 
                    alt="choicetime" 
